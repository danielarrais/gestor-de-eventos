...
class ActionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create action" do
    assert_difference('Action.count') do
      post actions_url, params: { action: { description: @action.description, key: @action.key, name: @action.name } }
    end
  ...
  test "should update action" do
    patch action_url(@action), params: { action: { description: @action.description, key: @action.key, name: @action.name } }
